      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 md:text-xl max-w-[700px] mt-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      <section className="py-12 md:py-24 bg-muted/50">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 md:text-lg max-w-[700px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="flex flex-col items-center text-center rounded-xl bg-card text-card-foreground p-8 shadow-sm border">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                Home
              </Link>
              <Link to="/about" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                About
              </Link>
              <Link to="/features" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                Features
              </Link>
              <Link to="/login" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                Log in
              </Link>
            </div>
          </div>
