...
const Logo = () => {
  ...
  return <Link to="/" className="flex items-center space-x-2 group">
      ...
      <div className="h-14 w-14 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse"></div> : theme === 'dark' ? <img src="/lovable-uploads/dd549a30-bc8f-43b0-92ed-805c735d311a.png" alt="Berugn Logo" className="h-14 w-14" /> : <img src="/lovable-uploads/33711422-1b29-4369-b58c-e13edeeffacd.png" alt="Berugn Logo" className="h-19 w-19 object-fill" />}
